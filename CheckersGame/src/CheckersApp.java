...
public class CheckersApp extends Application {
	...
	public void playButtonPressed ( ActionEvent event) {
		...
		// ((Stage)(((Button)event.getSource()).getScene().getWindow())).close(); Close window or not?
	}
	...
	public void connectButtonPressed ( ActionEvent event ) {
		...
		labelAbovePlay.setText ( "Welcome " + loginFormUsername.getText ( ) + " press the play button to start " +
			"a" + " game!" );
